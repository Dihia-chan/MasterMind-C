...
void fin( SDL_Surface *ecran ,int S ,int cpt  ,int pl  )
{
   ...
   if (pl==4)
   {
       ...
       menu = IMG_Load("ganier2.png");
        ...
        textej = TTF_RenderText_Blended(police, " Tu as GANIER!! " , couleurNoire);
    ...
    retour = TTF_RenderText_Blended(police, " Cliquez sur ENTRE si vous voulez reprandre " , couleurNoire);
